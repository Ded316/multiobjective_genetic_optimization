...
import jmetal.problems.tp1_schaffer;
import jmetal.problems.tp1_schwefel;
import jmetal.problems.tp2_fct_agregation;
...
public class GA_main {
  public static void main(String [] args) throws JMException, ClassNotFoundException {
    ...
    int bits = 10 ;
    //problem = new tp1_schaffer("Real", bits);
    //problem = new tp1_schwefel("Real", bits);
    problem = new tp2_fct_agregation("Real", bits, 1.0, 1.0);
    ...
    */
    ...
    parameters.put("perturbation", 1.0) ;
