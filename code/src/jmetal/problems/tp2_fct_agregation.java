...
//Fonction multi-objectifs : Approche scalaires
 ...
 */
public class tp2_fct_agregation extends Problem {    
	...
	double alpha, beta;
	public tp2_fct_agregation(String solutionType, Integer numberOfVariables, double alpha, double beta) {
	...
	public void evaluate(Solution solution) throws JMException {
		...
		double f=0, f1=0, f2=0, C, N=numberOfVariables_;
	    ...
	    C = f1 + f2 - Math.abs(Math.sin(N*Math.PI*(f1 - f2 + 1)))-1;
